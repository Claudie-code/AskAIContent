...
const Sidebar: React.FC<SidebarProps> = ({ handleOpenParameters }) => {
  ...
  const iconStyle =
    "items-center font-bold transition-all hover:bg-elementBg active:bg-activeElementBg group relative flex justify-center rounded px-2 py-1.5";
    ...
    <div className={sidebarClasses}>
      <div className="flex flex-col gap-2">
        ...
        <div className="flex justify-end">
          {isSidebarOpen ? (
            <button onClick={handleCloseSidebar} className={iconStyle}>
              <svg
